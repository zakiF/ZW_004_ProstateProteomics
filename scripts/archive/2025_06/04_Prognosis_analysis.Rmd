...
We will not use the results from this part, because we will pool data from the initial psomagen cohort with the Olink batches. Then only in this pooled data, we will do the prognisis analysis.

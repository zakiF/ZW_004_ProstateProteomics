...
For these proteins run a cox proportional analysis. For completness, we will do this analysis in the Olink batch corrected NPX value and the Limma batch corrected NPX values
